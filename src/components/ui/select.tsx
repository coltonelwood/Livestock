...
/**
 * Native <select> wrapper. We use a native control (not a JS popover) on
 * purpose: it is the most reliable, accessible option on low-end rural mobile
 * devices and works inside server-action forms without client JS.
 */
